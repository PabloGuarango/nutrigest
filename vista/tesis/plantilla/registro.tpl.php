...
<div class="pace-activity"></div></div>
        ...
        <div class="register-wrapper">
            <div id="register" class="login loginpage col-lg-offset-4 col-lg-4 col-md-offset-3 col-md-6 col-sm-offset-3 col-sm-6 col-xs-offset-0 col-xs-12">
                ...
                <form name="loginform" id="loginform" action="{siteurl}/administracion/registrarme" method="post">
                    <p>
                        <label for="user_login">Nombres Completos<br>
                            <input type="text" name="nombres" id="user_login" class="input" value="" size="20"></label>
                    </p>
                    
                    <p>
                        <label for="user_login">Email<br>
                            <input type="email" name="email" required id="user_login" class="input" value="" size="200"></label>
                    </p>
                    
                    <p>
                        <label for="user_pass">Contraseña<br>
                            <input type="password" name="password" required id="user_pass" class="input" value="" size="20"></label>
                    </p>
                    
                    <p class="submit">
                        <input type="submit" name="wp-submit" id="wp-submit" class="btn btn-orange btn-block" value="Registrarme">
                        <input type="hidden" name="registrarme" value="true125417">
                    </p>
